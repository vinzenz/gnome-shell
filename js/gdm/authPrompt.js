...
const AuthPrompt = new Lang.Class({
    ...
    _init: function(gdmClient, mode) {
        ...
        this._userVerifier.connect('ovirtcred-user-authenticated', Lang.bind(this, this._onOVirtCredUserAuthenticated));
    ...
    reset: function() {
        ...
        } else if (this._userVerifier.serviceIsForeground(GdmUtil.OVIRTCRED_SERVICE_NAME) ||
                   (this.smartcardDetected &&
